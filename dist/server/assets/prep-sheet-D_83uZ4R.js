import { n as useLegalSession, r as CATEGORY_LABEL } from "./useLegalSession-D_I0Bgva.js";
import { useCallback, useEffect, useId, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Download, FileDown, Loader2, Printer, RefreshCw } from "lucide-react";
//#region src/components/prep/PrepSheetDocument.tsx
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [sheet.questions.map((question) => /* @__PURE__ */ jsx("li", {
					...
					}, question.id)), sheet.questions.length === 0 ? /* @__PURE__ */ jsx("li", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					children: [sheet.chatHighlights.map((highlight, index) => /* @__PURE__ */ jsxs("li", {
					...
					}, `${index}-${highlight.slice(0, 12)}`)), sheet.chatHighlights.length === 0 ? /* @__PURE__ */ jsx("li", {
...
//#endregion
//#region src/routes/prep-sheet.tsx?tsr-split=component
function PrepSheetPage() {
	...
	if (!analysis) return /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					children: [
						...
						/* @__PURE__ */ jsxs("button", {
							...
							children: [exporting ? /* @__PURE__ */ jsx(Loader2, {
								className: "size-4 animate-spin",
								"aria-hidden": "true"
			...
			/* @__PURE__ */ jsx("div", {
				...
				"aria-busy": loading,
				children: sheet ? /* @__PURE__ */ jsx(PrepSheetDocument, {
					sheet,
					notes
				}) : /* @__PURE__ */ jsx("p", {
